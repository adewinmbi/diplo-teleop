...
public class SuperstructureConstants {
    ...
    public static final int kRollerPeakCurrent = 40;
    ...
    public static final int kAcceptableErrorForStates = 200;
    public static final int kStowState = 0;
    public static final int kForwardScaleState = 1;
    public static final int kBackwardsScaleState = 2;
    public static final int kLowerForwardsScaleState = 3;
